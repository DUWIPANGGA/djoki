    ...
    <div class="flex">
        ...
        <aside class="w-72 h-screen sticky top-0 border-r border-white/5 bg-[#0f172a]/50 backdrop-blur-xl z-50 flex flex-col">
            <div class="p-8">
                ...
                <p class="text-[10px] uppercase tracking-widest text-slate-500 mt-1">Provider Console</p>
            </div>
        ...
        <main class="flex-1 p-8">
            <header class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-slate-400 text-sm">@yield('subheader', 'Selamat datang kembali, Provider.')</p>
                </div>
