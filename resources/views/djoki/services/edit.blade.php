...
@section('subheader', 'Ubah spesifikasi layanan.')
        ...
        <form action="{{ route('services.update', $service) }}" method="POST" class="space-y-6">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="name" name="name" required 
                           ...
                           placeholder="Contoh: Landing Page React" value="{{ old('name', $service->name) }}">
                ...
                <div>
                    ...
                    <input type="text" id="slug" name="slug" 
                           ...
                           placeholder="landing-page-react" value="{{ old('slug', $service->slug) }}">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" id="min_price" name="min_price" 
                           ...
                           placeholder="500000" value="{{ old('min_price', $service->min_price) }}">
                ...
                <div>
                    ...
                    <input type="number" id="max_price" name="max_price" 
                           ...
                           placeholder="2000000" value="{{ old('max_price', $service->max_price) }}">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="estimated_time" name="estimated_time" 
                           ...
                           placeholder="Contoh: 3-5 Hari" value="{{ old('estimated_time', $service->estimated_time) }}">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4 h-[50px]">
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" name="is_active" value="1" class="hidden peer" {{ old('is_active', $service->is_active) ? 'checked' : '' }}>
                        ...
                        <label class="flex items-center cursor-pointer">
                            <input type="radio" name="is_active" value="0" class="hidden peer" {{ !old('is_active', $service->is_active) ? 'checked' : '' }}>
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4" required
                          ...
                          placeholder="Jelaskan apa yang didapatkan user dari layanan ini...">{{ old('description', $service->description) }}</textarea>
